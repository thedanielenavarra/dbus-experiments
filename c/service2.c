...
int main() {
    DBusObjectPathVTable my_vtable = {
    .message_function = my_service_handler
};
    ...
    if (!dbus_connection_register_object_path(connection, "/com/example/MyService", &my_vtable, NULL)) {
